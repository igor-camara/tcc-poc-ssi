<template>
   <div class="min-h-screen bg-gradient-to-br from-amber-900 via-orange-800 to-yellow-900 flex">
      <!-- Sidebar -->
      <div class="w-64 bg-white/10 backdrop-blur-md border-r border-white/20 flex flex-col">
         ...
         <div class="p-6 border-b border-white/20">
            <div class="flex items-center space-x-2">
               ...
               <span class="text-white font-semibold text-xl">Painel Issuer</span>
            </div>
         </div>
         <!-- Navigation Menu -->
         ...
         <div class="p-4 border-t border-white/20">
            <div class="flex items-center space-x-3 mb-4">
               ...
               <div>
                  ...
                  <p class="text-amber-300 text-sm">{{ userRole }}</p>
               </div>
            </div>
            <button
               @click="handleLogout"
               class="flex items-center space-x-2 text-amber-200 hover:text-white cursor-pointer transition-colors duration-200 w-full px-2 py-1 rounded hover:bg-white/10"
               >
