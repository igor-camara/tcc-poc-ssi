      ...
      <Transition name="loading" appear>
         <div 
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-lg border border-white/20 p-8 flex flex-col items-center space-y-4">
               <!-- Spinner -->
               <div class="relative">
                  <div class="w-16 h-16 border-4 border-amber-600/30 rounded-full"></div>
                  <div class="absolute inset-0 w-16 h-16 border-4 border-amber-600 border-t-transparent rounded-full animate-spin"></div>
               </div>
               <!-- Loading Text -->
               <div class="text-center">
                  <h3 class="text-lg font-semibold text-white mb-1">Carregando...</h3>
                  <p class="text-amber-200 text-sm">Aguarde um momento</p>
               </div>
               <!-- Animated dots -->
