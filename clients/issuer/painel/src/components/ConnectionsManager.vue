   ...
   <div class="space-y-6">
      ...
      <div class="flex items-start justify-between gap-4 pr-2">
         <div class="flex-1">
            ...
            <p class="text-amber-200">Gerencie suas conexões de identidade auto-soberana</p>
         </div>
         <div class="flex-shrink-0">
            <Button @click="showGenerateUrlModal = true" class="bg-amber-600 hover:bg-amber-700 text-white cursor-pointer">
      ...
      <div class="space-y-4 max-h-[60vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-amber-600 scrollbar-track-white/10">
         ...
         >
            <div class="w-20 h-20 bg-amber-600/20 rounded-full flex items-center justify-center mx-auto mb-4">
               <Network class="w-10 h-10 text-amber-600" />
            </div>
                  ...
                  <div class="flex items-center space-x-4 flex-1">
                     ...
                     <div class="flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                           ...
                           <div>
                              <span class="text-amber-300">Criado em: </span>
                        ...
                        <div class="mt-2" v-if="connection.their_did">
                           <span class="text-amber-300">Their DID: </span>
      ...
      <!-- DID Document Modal -->
         <div
            ...
            <div
               ...
               <div class="bg-black/30 rounded-lg p-6 min-h-[400px]">
                  <pre class="text-amber-200 text-sm overflow-x-auto whitespace-pre-wrap">{{ selectedDidDocument }}</pre>
               </div>
            </div>
         </div>
         <!-- Generate URL Modal -->
               ...
               <form @submit.prevent="handleGenerateUrl" class="space-y-6">
                  <div class="space-y-2">
                     ...
                     <Input
                        ...
                        class="bg-white/20 border-white/30 text-white placeholder:text-amber-200 transition-all duration-200 focus:bg-white/30 focus:border-amber-400"
                        />
                  </div>
                  <div v-if="generatedUrl" class="space-y-3">
                     <label class="text-sm font-medium text-white">URL Gerada</label>
                     <div class="bg-black/30 rounded-lg p-4">
                        <p class="text-amber-200 text-sm break-all font-mono">{{ generatedUrl }}</p>
                     </div>
                     <Button
                        @click="copyUrlToClipboard"
                        type="button"
                        class="w-full bg-amber-600 hover:bg-amber-700 text-white cursor-pointer"
                        >
                        {{ urlCopied ? '✓ Copiado!' : 'Copiar URL' }}
                     </Button>
                  </div>
                  <div class="flex justify-end space-x-3 pt-4">
                     <Button @click="closeGenerateUrlModal" variant="ghost" class="text-amber-200 cursor-pointer">
                     ...
                     <Button 
                        ...
                        class="bg-amber-600 hover:bg-amber-700 text-white cursor-pointer transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50"
                        >
         ...
         <div
            ...
            >
            <div class="bg-gradient-to-br from-amber-900/90 to-amber-950/90 backdrop-blur-md rounded-xl border border-white/20 p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
               <div class="flex justify-between items-center mb-6">
               ...
               <div class="space-y-4">
                  <div class="bg-white/10 rounded-lg p-4 space-y-3">
                     <div class="flex justify-between items-start">
                        <span class="text-amber-300 font-medium">Alias:</span>
                     ...
                     <div class="flex justify-between items-start">
                        <span class="text-amber-300 font-medium">Criado em:</span>
                        <span class="text-white">{{ formatDate(selectedConnection.created_at) }}</span>
                     </div>
                     <div class="flex justify-between items-start">
                        <span class="text-amber-300 font-medium">Atualizado em:</span>
