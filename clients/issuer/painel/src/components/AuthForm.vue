<template>
   <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-900 via-orange-800 to-yellow-900">
      <div class="w-full max-w-md p-8">
         <div class="bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-2xl p-8 animate-slide-up">
            <div class="text-center mb-8">
               ...
               <p class="text-amber-200">Acesse sua conta ou crie uma nova</p>
            </div>
            <Tabs v-model="activeTab" class="w-full">
               <TabsList class="grid w-full grid-cols-2 bg-white/20">
                  <TabsTrigger value="login" class="data-[state=active]:bg-amber-600 text-white cursor-pointer transition-all duration-200 hover:bg-white/30">
                     Login
                  </TabsTrigger>
                  <TabsTrigger value="register" class="data-[state=active]:bg-amber-600 text-white cursor-pointer transition-all duration-200 hover:bg-white/30">
                     Registro
                  </TabsTrigger>
               </TabsList>
                     ...
                     <div class="animate-fade-in">
                        <form @submit.prevent="handleRegister" class="space-y-4">
                           ...
                           <Button
                              type="submit"
                              :disabled="appStore.isLoading"
                              class="w-full bg-amber-600 hover:bg-amber-700 text-white cursor-pointer transition-all duration-200 transform hover:scale-105 disabled:cursor-not-allowed disabled:hover:scale-100"
                              >
