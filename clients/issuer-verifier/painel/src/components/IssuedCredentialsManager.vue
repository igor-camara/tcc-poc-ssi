  ...
  <div class="space-y-6">
    ...
    <div class="flex items-start justify-between gap-4 pr-2">
      <div class="flex-1">
        ...
        <p class="text-blue-100">Gerencie as credenciais emitidas e envie novas ofertas</p>
      </div>
          ...
          <div class="flex items-start justify-between">
                ...
                <div class="space-y-2">
                  ...
                  <div class="mt-3">
                    <button
                      ...
                      class="flex items-center text-sm text-blue-200 hover:text-blue-100 transition-colors cursor-pointer"
                    >
                      <ChevronDown 
                    ...
                    >
                      ...
                      >
                        <span class="text-blue-200 font-medium">{{ key }}:</span>
            ...
            <div class="flex space-x-2 ml-4">
              ...
              <Button
                ...
                class="text-blue-200 hover:text-blue-100 hover:bg-white/10 cursor-pointer"
              >
    ...
    >
      <div class="bg-gradient-to-br from-blue-900/90 to-blue-950/90 backdrop-blur-md rounded-xl border border-white/20 p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="submitOffer" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <Input
                ...
                class="bg-white/20 border-white/30 text-white placeholder:text-blue-100 disabled:opacity-50 disabled:cursor-not-allowed"
              />
              <Search class="w-4 h-4 absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-200" />
            </div>
            ...
            >
              ...
              >
                ...
                <div class="text-xs text-blue-100">ID: {{ conn.connection_id }}</div>
              </button>
            </div>
            ...
            <div 
              ...
              class="bg-blue-600/20 border border-blue-600/30 rounded-lg p-3 mt-2"
            >
              <div class="flex items-center justify-between">
                <div>
                  <div class="text-white font-medium">{{ selectedConnection?.alias }}</div>
                  <div class="text-xs text-blue-100">{{ offerForm.connection_id }}</div>
                </div>
                <button
                  type="button"
          ...
          <div class="space-y-2">
            ...
            <Select v-model="offerForm.schema_id" @update:model-value="onSchemaChange">
              ...
              <SelectContent class="bg-blue-900/95 backdrop-blur-md border-white/30 shadow-xl">
                <SelectGroup>
                  <SelectLabel class="text-blue-200 font-semibold px-2 py-1.5">
                    Schemas Disponíveis
                  </SelectLabel>
                  <SelectItem
          ...
          <div v-if="schemaAttributes.length > 0" class="space-y-4">
            ...
            <div 
              ...
              class="space-y-2"
            >
              <label class="text-sm text-blue-100">{{ attr }}</label>
              <Input
          ...
          <div class="flex justify-end space-x-3 pt-4 border-t border-white/20">
            <Button
              type="button"
              @click="closeOfferModal"
              class="bg-white/10 hover:bg-white/20 text-blue-100 hover:text-white border border-white/20 cursor-pointer transition-colors"
            >
              Cancelar
            </Button>
            <Button
              ...
              class="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Send class="w-4 h-4 mr-2" />
              Enviar Oferta
            </Button>
    ...
    >
      <div class="bg-gradient-to-br from-blue-900/90 to-blue-950/90 backdrop-blur-md rounded-xl border border-white/20 p-6 w-full max-w-xl">
        <div class="flex justify-between items-center mb-6">
        ...
        <div class="space-y-4">
          <div class="bg-white/10 rounded-lg p-4 space-y-3">
            <div class="flex justify-between">
              <span class="text-blue-200 font-medium">Nome:</span>
            ...
            <div class="flex justify-between">
              <span class="text-blue-200 font-medium">Data de Emissão:</span>
              <span class="text-white">{{ formatDate(selectedCredential.issued_at) }}</span>
            </div>
            <div class="flex justify-between">
              <span class="text-blue-200 font-medium">Destinatário:</span>
              <span class="text-white">{{ selectedCredential.holder_alias || 'N/A' }}</span>
            </div>
          </div>

          <div class="bg-white/10 rounded-lg p-4">
            <h4 class="text-blue-200 font-medium mb-3">Atributos:</h4>
            <div class="space-y-2">
              <div 
          ...
          <div class="bg-white/10 rounded-lg p-4">
            <h4 class="text-blue-200 font-medium mb-2">ID de Troca:</h4>
          ...
          <div class="bg-white/10 rounded-lg p-4">
            <h4 class="text-blue-200 font-medium mb-2">Definition ID:</h4>
            <code class="text-xs text-white break-all bg-black/30 p-2 rounded block">
